...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"service/api.js":[function(require,module,exports) {
"use strict";
...
var getPokemon = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$axios$get, data, _iterator, _step, pokemon, _yield$axios$get2, _data, div, name, img, weigth, height, _iterator2, _step2, type, h2;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("https://pokeapi.co/api/v2/pokemon?limit=1000&offset=0");
        case 3:
        ...
        case 8:
          ...
          pokemon = _step.value;
          _context.next = 12;
          return _axios.default.get(pokemon.url);
        case 12:
          ...
          weigth = document.createElement("h2");
          ...
          _iterator2 = _createForOfIteratorHelper(_data.types);
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              type = _step2.value;
              div.classList.add("shadow-2xl", "".concat(type.type.name === "grass" ? "border-green-500" : type.type.name === "fire" ? "border-orange-500" : type.type.name === "water" ? "border-blue-500" : type.type.name === "bug" || type.type.name === "poison" ? "border-purple-500" : type.type.name === "electric" ? "border-yellow-500" : type.type.name === "fairy" ? "border-pink-500" : type.type.name === "psychic" ? "border-indigo-500" : type.type.name === "dragon" ? "border-red-500" : "border-gray-500"), "".concat(type.type.name === "grass" ? "shadow-green-500" : type.type.name === "fire" ? "shadow-orange-500" : type.type.name === "water" ? "shadow-blue-500" : type.type.name === "bug" || type.type.name === "poison" ? "shadow-purple-500" : type.type.name === "electric" ? "shadow-yellow-500" : type.type.name === "fairy" ? "shadow-pink-500" : type.type.name === "psychic" ? "shadow-indigo-500" : type.type.name === "dragon" ? "shadow-red-500" : "shadow-gray-500"));
              h2 = document.createElement("h2");
              div.append(h2);
              h2.textContent = type.type.name;
              h2.classList.add("w-20", "font-bold", "text-center", "uppercase", "text-white", "rounded-lg", "".concat(type.type.name === "grass" ? "bg-green-500" : type.type.name === "fire" ? "bg-orange-500" : type.type.name === "water" ? "bg-blue-500" : type.type.name === "bug" || type.type.name === "poison" ? "bg-purple-500" : type.type.name === "electric" ? "bg-yellow-500" : type.type.name === "fairy" ? "bg-pink-500" : type.type.name === "psychic" ? "bg-indigo-500" : type.type.name === "dragon" ? "bg-red-500" : "bg-gray-500"));
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
